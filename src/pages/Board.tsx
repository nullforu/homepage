    ...
    return (
        <Layout>
            <div className='max-w-4xl mx-auto px-4 py-6'>
                <h1 className='text-3xl md:text-4xl font-semibold mb-8'>게시판</h1>
                ...
                <div className='border border-gray-100 rounded-xl overflow-hidden'>
                    ...
                    <div>
                        {notices.map((notice, index) => (
                            ...
                            >
                                <div className='col-span-1 text-center text-gray-600'>{notices.length - index}</div>
                                <div className='col-span-6 font-medium'>{notice.title}</div>
                                ...
                                <div className='col-span-1 text-center text-gray-600'>{notice.views}</div>
                            </div>
                        ))}
                    </div>
                </div>
