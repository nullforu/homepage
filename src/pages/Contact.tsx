        ...
        <Layout>
            <div className='max-w-4xl mx-auto px-4 py-6'>
                <div className='bg-white rounded-xl p-8 animate-fadeIn'>
                    <h1 className='text-3xl md:text-4xl font-bold mb-8'>연락처</h1>

                    <section className='mb-12'>
                        <h2 className='text-2xl font-bold mb-6'>동아리 정보</h2>
                    ...
                    <section className='mb-12'>
                        <h2 className='text-2xl font-bold mb-6'>우두머리</h2>
                        <div className='grid gap-4'>
                            <div className='border border-gray-100 p-6 rounded-xl hover:shadow-lg transition-all duration-300'>
                                <div className='flex justify-between items-start mb-3'>
                                    <h3 className='text-lg font-bold'>김준영</h3>
                                    <span className='text-sm bg-gray-900 text-white px-4 py-1.5 rounded-full'>
                                        부장
                                    </span>
                                </div>
                    ...
                    <section className='mb-12'>
                        <h2 className='text-2xl font-bold mb-6'>SNS</h2>
                    ...
                    <section>
                        <h2 className='text-2xl font-bold mb-6'>참고</h2>
                        <div className='border border-gray-100 p-6 rounded-xl'>
                            <h3 className='font-bold text-lg mb-3'>ㅌㅇㅇ</h3>
