    ...
    return (
        <Layout>
            <div className='max-w-6xl mx-auto px-4 py-6'>
                <section className='py-16 text-center bg-white rounded-xl mb-6'>
                    <h1 className='text-4xl md:text-5xl font-semibold mb-4'>Null4U</h1>
                ...
                <section className='py-12 bg-white rounded-xl mb-6'>
                    <h2 className='text-3xl font-semibold text-center mb-10'>최근 소식</h2>
                    <div className='space-y-4 px-4'>
                        <div className='border border-gray-100 rounded-xl p-6 hover:shadow-lg transition-all duration-300 cursor-pointer'>
                            <div className='flex justify-between items-start mb-3'>
                                <h3 className='text-lg font-semibold'>ㅈㅈㅈ</h3>
                                <span className='text-xs text-gray-500'>ㅇㅇ</span>
                            </div>
                            <p className='text-gray-600 text-sm leading-relaxed'>ㅇㅇ</p>
                        </div>
                        <div className='border border-gray-200 rounded-lg p-5 hover:shadow-md transition-all cursor-pointer'>
                            ...
                            <p className='text-gray-700 text-sm'>ㄴㅇㅎㄹㄴㄴㄹ</p>
                        </div>
                        <div className='border border-gray-200 rounded-lg p-5 hover:shadow-md transition-all cursor-pointer'>
                            <div className='flex justify-between items-start mb-2'>
                            ...
                            <p className='text-gray-700 text-sm'>ㅇㄴㅁㅇㄴㄹ</p>
                        </div>
                    </div>
                </section>
