    ...
    return (
        <>
            <nav className={`bg-white fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
                ...
                <div className={`max-w-6xl mx-auto px-4 bg-white border transition-all duration-300 ${
                    isAtTop 
                        ? 'border-transparent md:rounded-none shadow-none' 
                        : 'border-transparent md:border-gray-200 md:rounded-2xl md:shadow-md'
                }`}>
                            ...
                            {menuItems.map(item => (
                                ...
                                >
                                    ...
                                    {item.dropdown && openDropdown === item.path && (
                                        ...
                                        >
                                            <div className="w-40 bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden animate-fadeIn">
            ...
            <div className={`fixed top-0 left-0 bottom-0 w-64 bg-white shadow-2xl z-[52] md:hidden transform transition-transform duration-300 ease-in-out ${
